...
export const MarketResearchForm = () => {
    ...
    const company = (marketData.companyDetails || {}) as Partial<MarketResearchData['companyDetails']>;
    const audience = (marketData.targetAudience || {}) as Partial<MarketResearchData['targetAudience']>;
    const offer = (marketData.unifiedOffer || {}) as Partial<MarketResearchData['unifiedOffer']>;

    const handleChange = (section: string, field: string, value: any) => {
        // Construct the full path key for store updates if needed, 
        // OR just pass the nested object. 
        // The store `updateFormData` implementation handles 2 levels: phase + section.
